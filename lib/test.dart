...
class _DailyWorkListPageState extends State<DailyWorkListPage> {
 DateTime _selectedDate = DateTime.now();
  double _totalImpressionAmount = 0.00;
  double _totalPayment = 0.0;
  double _noofimpression = 0;
  List<dynamic> dailyWorks = [];
  int _currentIndex = 0;
  double _dailyIncome = 0.00;
  ...
  Widget _buildDataCard(String title, String value) {
    return Container(
      decoration: BoxDecoration(
        border: Border.all(color: const Color.fromARGB(255, 243, 128, 20), width: 5),
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            value,
            style: const TextStyle(color: Color.fromARGB(255, 156, 2, 136), fontSize: 24),
          ),
        ],
      ),
    );
